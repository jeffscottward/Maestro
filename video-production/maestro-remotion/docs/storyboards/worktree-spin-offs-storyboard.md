...
- Source-of-truth note: market the piece as `Worktree Spin-offs`, but keep on-screen UI labels exact as `Run in Worktree` and `Dispatch to a separate worktree`
...
| ------------ | ------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------- |
| 1            | Frame branch contamination risk inside the real Auto Run workflow. | Let Auto Run help without touching the current checkout.<br>Branch safety is the product promise.                                      | Batch runner modal with Auto Run context visible before the worktree section takes focus.        | Auto Run run-launch surface in a git-backed session.                                        | Open the Auto Run run launcher for a git-backed repository.         | `Run in Worktree` appears as an available part of the launch flow.                                      | Tight reveal from document list into the lower configuration surface.  | 5                |
